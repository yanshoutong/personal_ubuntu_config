...
syn region  javaScriptStringTemplate   start="`"  end="`" contains=@Spell,javaScriptCommentTodo
...
syn keyword javaScriptOperator		new delete instanceof typeof Self  resolve reject
syn keyword javaScriptType		Array Boolean Date Function Number Object String RegExp Promise async await
...
syn keyword javaScriptReserved		abstract boolean byte char class const debugger double enum export extends final float goto implements import int interface long native package private protected public short static super synchronized throws transient volatile constructor
...
hi def link javaScriptStringTemplate   Comment
